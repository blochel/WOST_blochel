...
boundaries <- load_boundaries('C:/Users/alexanderblochel/OneDrive - University of Florida/Desktop/wading_bird_project/wadingbirds_weecology/EvergladesWadingBird/SiteandMethods/regions/',
                              level = "subregions")
